...
class _SpaPageState extends State<SpaPage> {
  ...
  final List<String> _spaImages = [
    'assets/images/homepage4.jpg',
    'assets/images/homepage6.jpg',
  ...
  Future<void> _submitReservation() async {
    ...
    try {
      ...
      DocumentReference docRef = await FirebaseFirestore.instance.collection('SpaReservations').add({
        'date': formattedDate,
        'time': _selectedTime,
        'userName': userName,
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text(
                            'Note: Spa services are available between 10:00 AM and 10:00 PM.',
                            style: TextStyle(
                              fontSize: 14,
                              color: Colors.grey,
                            ),
